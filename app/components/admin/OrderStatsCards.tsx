import { ClipboardList, Clock, CheckCircle2, Package, FileCheck } from "lucide-react";
...
export default function OrderStatsCards({ orders }: OrderStatsCardsProps) {
  ...
  const stats = [
    { label: "Total Orders", value: orders.length, icon: ClipboardList, color: "bg-blue-600" },
    { label: "Pending", value: pending, icon: Clock, color: "bg-amber-500" },
    { label: "Accepted", value: accepted, icon: FileCheck, color: "bg-sky-500" },
  ...
  return (
    <div className="grid grid-cols-2 gap-4 lg:grid-cols-5">
      ...
      <div className="col-span-2 rounded-2xl border border-blue-100 bg-blue-50 p-4 lg:col-span-5">
