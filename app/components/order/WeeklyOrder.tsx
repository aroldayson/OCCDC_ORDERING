...
export default function WeeklyOrder({
  ...
  async function handleSubmit() {
    ...
    // Persist any local-only custom products to Supabase before saving the order
    for (const localProduct of localCustomProducts) {
      await addWeeklyProduct(
        {
          id: localProduct.id,
          name: localProduct.name,
          defaultQty: localProduct.defaultQty,
