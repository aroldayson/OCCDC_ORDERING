        ...
        <div className="flex flex-col justify-center p-6 sm:p-10 md:p-14 overflow-y-auto max-h-[90vh] lg:max-h-none relative">
          ...
          <div className="w-full max-w-[380px] mx-auto">
            ...
            <div className="mt-8 relative flex items-center justify-center">
              ...
              <span className="relative bg-white px-4 text-xs text-slate-500 font-medium uppercase tracking-wider">
                or
              </span>
            </div>
            ...
            <div className="mt-10 pt-6 border-t border-slate-100 flex flex-col items-center gap-4">
              <div className="inline-flex items-center gap-2 rounded-full bg-slate-50 border border-slate-100 px-4 py-1.5 text-xs font-medium text-slate-600 shadow-sm">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 1.944A11.954 11.954 0 012.166 5C2.056 5.649 2 6.319 2 7c0 5.225 3.34 9.67 8 11.317C14.66 16.67 18 12.225 18 7c0-.682-.057-1.35-.166-1.998A11.954 11.954 0 0110 1.944zM11 14a1 1 0 11-2 0 1 1 0 012 0zm0-7a1 1 0 10-2 0v3a1 1 0 102 0V7z"
                    clipRule="evenodd"
                  />
                </svg>
